...
//If the hour is from 0 - 11 print out 'Good Morning' to the console
    if (hour <= 11) {
        console.log('Good Morning!')
//Else if the hour is between 12 and 16 print out 'Good Afternoon' to the console
    } else if (hour >= 12 && hour <= 16) {
        console.log('Good Afternoon!')
//Else if the hour is between 17 and 21 print out 'Good Evening' to the console
    } else if (hour >= 17 && hour <= 21) {
        console.log('Good Evening!')
//Else if the hour is between 22 and 24 print out 'Good Night' to the console
